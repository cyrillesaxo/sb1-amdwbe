...
export const vehicleTypes = [
  ...
  {
    id: 'motorcycle',
    name: 'delivery.vehicleTypes.motorcycle',
    description: 'delivery.vehicleDescriptions.motorcycle',
    icon: Bike, // Using Bike icon as fallback since Motorcycle isn't available
    maxWeight: '30kg',
